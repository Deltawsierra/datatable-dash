...
init.py
"""
Bulk upload ingestion utilities for publishing metadata to Data Atlas.
"""
...
env vars
export DATA_ATLAS_GRAPHQL_URL="https://your-data-atlas-host/api/graphql"
export DATA_ATLAS_TOKEN="your-token-here"



optional env vars
export DATA_ATLAS_ACTOR="urn:li:corpuser:datahub"
export DATA_ATLAS_VERIFY_SSL="true"
export DATA_ATLAS_TIMEOUT_SECONDS="30"



if datahub doesnt use standard bearer header
export DATA_ATLAS_AUTH_HEADER="X-DataAtlas-Token"
export DATA_ATLAS_AUTH_SCHEME=""



run examples
python scripts/bulk_uploads/glossary.py template.xlsx --dry-run
python scripts/bulk_uploads/descriptions.py template.xlsx --sheet "Description Template" --dry-run
