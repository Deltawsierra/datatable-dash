...
export type ThemeCategory = 'classic' | 'seasonal' | 'special';
...
export interface ColorSchemeDefinition {
  ...
  /* Forces Ant Design dark algorithm even in "light" colorMode.
     Use for themes with inherently dark backgrounds. */
  forceDark: boolean;
